...
//   const isFormValid = form.firstName && form.lastName && form.passportNumber && form.dob && form.gender && form.email && form.city && form.occupation && form.passportExpiry && form.passportNumber && form.phone && form.relation && form.state;
...
//     try {
//       const res = await fetch( import.meta.env.VITE_API_LOCAL_URL + "/api/addTraveller", {
//         method: "POST",
...
//   const save = async () => {
//     const traveller = await saveTraveller();
